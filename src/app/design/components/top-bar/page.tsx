  ...
  return (
    <div className={styles.page}>
      ...
      <p className={styles.subtitle}>
        Page heading + description on the left, an optional{" "}
        <code>actions</code> slot on the right (e.g. Campaigns&apos; "Create
        Campaign" button lives here, on the same row as the heading — not
        floating above the table). The account menu moved to a footer
        pinned at the bottom of Sidebar Nav. A <code>breadcrumb</code> +{" "}
        <code>onBack</code> pair renders a back button and a
        "Section / Page" heading, for drill-in pages like a campaign's detail
        view.
      </p>
