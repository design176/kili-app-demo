  ...
  return (
    <div className={styles.page}>
      ...
      <p className={styles.subtitle}>
        Centered modal for topping up account balance — amount field (min $100),
        quick-select pills ($200/$500/$1,000/$2,000), Cancel (Secondary) + Add
        (Primary). Used from the Sidebar Nav balance card and Billing&apos;s
        &quot;Add balance&quot; button.
      </p>
