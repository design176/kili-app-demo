    ...
    <div className={styles.page}>
      ...
      <div className={styles.section}>
        ...
        <ul style={{ fontSize: 13, color: "var(--color-text-muted)", lineHeight: 2, paddingLeft: 18 }}>
          ...
          <li><strong>Balance / API keys / Pixel keys / Company logo / Wallet address resets</strong> — standalone actions (&quot;Reset to $0&quot;, &quot;Clear all&quot;, &quot;Clear&quot;) that wipe each independently of the New user flag, for when you just want one reset without the other.</li>
        </ul>
      </div>
